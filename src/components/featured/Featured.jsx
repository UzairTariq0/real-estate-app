...
import House1 from "../../assets/housse1.jpg";
import Bed1 from "../../assets/bed1.jpg";
import Bed2 from "../../assets/bed2.jpg";
import Kitchen from "../../assets/kitchen.jpg";
import Bathroom from "../../assets/bathroom1.jpg";

import House2 from "../../assets/housse2.jpg";
    ...
    <div className="featured">
      ...
      <div className="container">
        ...
        <div className="span-3 img-details">
          <div className="top">
            <h2>143 Acsee St. Dallas, TX</h2>
            <p>House for Sale</p>
            <p className="price">$3,210,000</p>
          </div>
      ...
      <div className="container">
        ...
        <div className="span-3 img-details order-6">
          <div className="top">
            <h2>25 Street Ft. New York, SS</h2>
            <p>House for Sale</p>
            <p className="price">$5,124,570</p>
          </div>
          <div className="info-grid">
            <div>
              <div className="info">
